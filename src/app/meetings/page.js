...
import db from '@/data/db.json';          // contiene cells[] y members[]
const { cells, members } = db;
...
export default function MeetingsPage() {
  ...
  const [envelopes, setEnvelopes] = useState([]);  // lista de sobres
